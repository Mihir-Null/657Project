...
\begin{frame}{Contextualizing Results}
  \begin{itemize}
    ...
    \item Further analysis would require simulation at higher block lengths
    \item Initial tests consistent with the hypothesis practical yield at low $n$
...
\begin{frame}{Hypothesis vs Results}
  \begin{itemize}
    ...
    \item Preliminary simulations seem to support this.
    \item Strengths:
      \begin{itemize}
